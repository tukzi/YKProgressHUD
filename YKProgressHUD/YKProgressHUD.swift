...
public typealias YKCompletion = (() -> Void)

// MARK: - YKProgressHUD
public class YKProgressHUD: UIView {
    /// 全局中间变量
    ...
    fileprivate var completion: YKCompletion?
    ...
    /// gif(YKProgressHUDType)
    fileprivate lazy var gifView: YKGifView = YKGifView()
    
    /// image(YKProgressHUDType)
    ...
    /// progress(YKProgressHUDType)
    fileprivate lazy var progressView: YKProgressView = {
        $0.progressColor = Config.foregroundColor
        $0.backgroundColor = .clear
        return $0
    }(YKProgressView(frame: CGRect(x: 0, y: 0, width: 85, height: 85)))
    
    /// activityIndicator(YKProgressHUDType)
    ...
    public override init(frame: CGRect) {
        ...
        NotificationCenter.default.addObserver(
            self,
            selector: #selector(YKProgressHUD.observerDismiss),
            name: Config.YKNSNotificationDismiss,
            object: nil
        )
    }
    ...
    deinit {
        NotificationCenter.default.removeObserver(self, name: Config.YKNSNotificationDismiss, object: nil)
    }
}

// MARK: - 实例计算属性
extension YKProgressHUD {
...
extension YKProgressHUD {
    ...
    fileprivate func show(hudType: HUDType,
                          ...
                          completion: YKCompletion? = nil,
                          onlyOnceFont: UIFont? = nil,
                          autoDismissDelay: Double? = nil) {
        YKProgressHUD._isShowing = true
    ...
    func animationDsmiss() {
        UIView.animate(withDuration: 0.3, animations: {
            ...
            self.isShow = false
            YKProgressHUD._isShowing = false
...
// MARK: - 类计算属性
extension YKProgressHUD {
    static var shared: YKProgressHUD {
        return YKProgressHUD(frame: UIScreen.main.bounds)
    }
    static var first: YKProgressHUD? {
        return UIWindow.frontWindow?.subviews.first(where: {
            $0.isKind(of: YKProgressHUD.self) && $0.restorationIdentifier == Config.restorationIdentifier
        }) as? YKProgressHUD
    }
}
...
extension YKProgressHUD {
    ...
    public static func showGif(
        gifUrl: URL?, gifSize: CGFloat?, status: String? = nil, maskStyle: YKProgressHUDMaskStyle? = nil, onlyOnceFont: UIFont? = nil) {
        shared.show(hudType: .gif, status: status, maskStyle: maskStyle, gifUrl: gifUrl, gifSize: gifSize, onlyOnceFont: onlyOnceFont)
    }
    
    /// 显示图片
    public static func showImage(_ image: UIImage?, status: String? = nil, maskStyle: YKProgressHUDMaskStyle? = nil, onlyOnceFont: UIFont? = nil, autoDismissDelay: Double? = nil, completion: YKCompletion? = nil) {
    ...
    /// 显示消息
    public static func showMessage(_ message: String?, maskStyle: YKProgressHUDMaskStyle? = nil, onlyOnceFont: UIFont? = nil, autoDismissDelay: Double? = nil, completion: YKCompletion? = nil) {
    ...
    /// 显示进度
    public static func showProgress(_ progress: CGFloat?, status: String? = nil, maskStyle: YKProgressHUDMaskStyle? = nil, onlyOnceFont: UIFont? = nil) {
        var isShowProgressView = false
        for subview in (UIWindow.frontWindow?.subviews)! {
            if subview.isKind(of: YKProgressHUD.self) && subview.restorationIdentifier == Config.restorationIdentifier {
                let progressHUD = subview as! YKProgressHUD
    ...
    /// 显示加载
    public static func show(_ status: String? = nil, maskStyle: YKProgressHUDMaskStyle? = nil, onlyOnceFont: UIFont? = nil) {
        shared.show(hudType: .activityIndicator, status: status, maskStyle: maskStyle, onlyOnceFont: onlyOnceFont)
    }
    
    /// 显示普通信息
    public static func showInfo(_ status: String? = nil, maskStyle: YKProgressHUDMaskStyle? = nil, onlyOnceFont: UIFont? = nil, autoDismissDelay: Double? = nil, completion: YKCompletion? = nil) {
    ...
    /// 显示成功信息
    public static func showSuccess(_ status: String? = nil, maskStyle: YKProgressHUDMaskStyle? = nil, onlyOnceFont: UIFont? = nil, autoDismissDelay: Double? = nil, completion: YKCompletion? = nil) {
    ...
    /// 显示失败信息
    public static func showError(_ status: String?, maskStyle: YKProgressHUDMaskStyle? = nil, onlyOnceFont: UIFont? = nil, autoDismissDelay: Double? = nil, completion: YKCompletion? = nil) {
    ...
    public static func hide(delay: Double? = nil) {
        YKProgressHUD.dismiss(delay)
    }
    /// 移除
    public static func dismiss(_ delay: Double? = nil) {
        NotificationCenter.default.post(name: Config.YKNSNotificationDismiss, object: nil, userInfo: ["delay" : delay ?? 0])
    }
    
    /// 设置遮罩样式，默认值：.visible
    public static func setMaskStyle (_ maskStyle: YKProgressHUDMaskStyle) {
        Config.maskStyle = maskStyle
    }
    
    /// 设置动画显示/隐藏样式，默认值：.fade
    public static func setAnimationShowStyle (_ animationShowStyle: YKProgressHUDAnimationShowStyle) {
    ...
    public static func setEffectStyle(_ hudEffectStyle: YKProgressHUDEffectStyle) {
    ...
    public static func setAnimationStyle(_ animationStyle: YKProgressHUDAnimationStyle) {

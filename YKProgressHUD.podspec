...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of YKProgressHUD.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/hesong_ios@163.com/YKProgressHUD'
  ...
  s.source_files = 'YKProgressHUD/Classes/**/*'
  
  # s.resource_bundles = {
  #   'YKProgressHUD' => ['YKProgressHUD/Assets/*.png']
  # }
